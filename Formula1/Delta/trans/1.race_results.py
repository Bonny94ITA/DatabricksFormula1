...
merge_delta_data(final_df, 'f1_presentation_delta', 'race_results', presentation_folder_path, merge_condition, 'race_id')

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM f1_presentation_delta.race_results;
