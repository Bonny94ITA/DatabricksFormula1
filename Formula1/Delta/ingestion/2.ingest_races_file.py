...
races_selected_df.write.mode("overwrite").partitionBy('race_year').format("delta").saveAsTable("f1_processed_delta.races")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM f1_processed_delta.races;
